...
class Yritys {
    ...
    lisaaTyontekija(tyontekija) {
        ...
        console.log(`Lisätty työntekijä. ${tyontekija.nimi}, työnumero: ${tyontekija.tyonumero}`);
    }

    listaaTyontekijat() {
        console.log(`${this.nimi}:n työntekijät: `);
        this.tyontekijat.forEach(tyontekija => console.log(`${tyontekija.nimi}, työnumero: ${tyontekija.tyonumero}`));
    }
}
