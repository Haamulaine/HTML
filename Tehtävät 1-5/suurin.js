...
if (luvut.some(isNaN)) {
    document.getElementById("tulos2").textContent = "Anna kaikkiin kenttiin luvut!";
...
document.getElementById("tulos2").textContent = `Suurin luku on: ${suurin}`;
document.getElementById("tulos2").style.color = "black";
}